...
#
#     @allure.story("添加商品分类")
#     @pytest.mark.parametrize('name',['test1','test2','test3'],ids=['第一次','第二次','第三次'])
#     def test_add_sku_list(self,name):
#         req_json={'description': '', 'icon':'' , 'keywords':'' , 'name':name , 'navStatus': 0, 'parentId': 0, 'productUni':'','showStatus':0,'sort':0}
#         add_sku_resp = request.post_request(url=url + 'productCategory/create',
